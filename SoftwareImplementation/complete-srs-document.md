...
|---------------|------------------------|----------|
| USR-01 | ระบบต้องรองรับการลงทะเบียนสมาชิกด้วย:<br>- ชื่อ-นามสกุล<br>- อีเมล (ใช้เป็น Username)<br>- รหัสผ่าน : <br>   •ความยาว 8-16 ตัวอักษร<br>   •มีตัวอักษรพิมพ์ใหญ่อย่างน้อย 1ตัว<br>   •มีตัวเลขอย่างน้อย 1 ตัว<br>   •มีอักขระพิเศษอย่างน้อย 1 ตัว<br>- เบอร์โทรศัพท์<br>- ที่อยู่ | High |
...
| Requirement ID | Requirement Description | Priority |
|---------------|------------------------|----------|
| BKG-01 | ระบบต้องรองรับการค้นหาห้องพักตามเงื่อนไข:<br>- วันเช็คอิน-เช็คเอาท์<br>- จำนวนผู้เข้าพัก (1-4 คน)<br>- ประเภทห้อง ((Standard/Deluxe/Suite))<br>-ช่วงราคา (min-mex)<br>- สิ่งอำนวยความสะดวก (เลือกได้หลายอย่าง) | High |
| BKG-02 | ระบบต้องแสดงข้อมูลห้องพักโดยละเอียด:<br>- รูปภาพห้องพักแบบ Gallery<br>- ราคาและค่าใช้จ่ายเพิ่มเติม<br>- สิ่งอำนวยความสะดวก<br>- ขนาดห้องและจำนวนผู้เข้าพักสูงสุด<br>- นโยบายการเข้าพักและยกเลิก<br>- คะแนนรีวิวและความคิดเห็น | High |
...
| Requirement ID | Requirement Description | Priority |
|---------------|------------------------|----------|
| PAY-01 | ระบบต้องรองรับการชำระเงินผ่าน:<br>- บัตรเครดิต/เดบิต<br>- Internet Banking<br>- E-Wallet<br>- QR Payment <br>- ทุกช่องทางต้องแสดงสถานะการชำระเงินทันทีและส่งใบยืนยันทางอีเมล | High |
...
| ROM-02 | ระบบต้องคำนวณค่าใช้จ่ายเพิ่มเติมระหว่างเข้าพัก <br>(ค่าปรับในกรณีสิ่งของชำรุดหรือสูญหาย และกรณีฝ่าฝืนกฏข้อห้ามของทางที่พัก)| High |
